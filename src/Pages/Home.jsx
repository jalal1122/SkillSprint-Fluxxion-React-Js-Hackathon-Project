      ...
      <ParallaxProvider>
        <div className="relative w-full h-screen overflow-hidden bg-white dark:bg-[#0f172a] transition-colors duration-500">
          ...
          <Parallax translateY={[-40, 40]} tagouter="figure">
              ...
              >
                Learn like never before — interactive, immersive, and
                futuristic.
              </motion.p>

              <motion.button
                className="mt-8 px-6 py-3 z-100 rounded-full bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition"
